...
const EntryPoints = imports.framework.entryPoints;
const HistoryItem = imports.framework.historyItem;
const Pages = imports.framework.pages;
const ReadingHistoryModel = imports.framework.readingHistoryModel;
const Utils = imports.framework.utils;
const WebShareDialog = imports.framework.widgets.webShareDialog;

let _ = imports.gettext.dgettext.bind(null, imports.framework.config.GETTEXT_PACKAGE);
