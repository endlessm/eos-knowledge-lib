 ...
 * A layout template that provides a top menu bar that slides out over the content.
 *
 * This layout template has one slot for its main content and a slot for the
 * top menu bar.
 *
 * The top menu appears starts out visible and then slides upwards, out of sight
 * as the user scrolls down the page (assuming content is a scrolling template).
 * When the user scrolls back up, the top menu slides out and becomes visible again.
 *
 * Implements:
 *   <Module>
 *
