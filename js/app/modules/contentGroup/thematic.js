 ...
 *
 * In contrast to the <Highlights> module, this module shows articles from one
...
const Thematic = new Module.Class({
    ...
    show_more_content: function () {
        ...
        let query = new QueryObject.QueryObject({
            limit: -1,
            tags_match_all: this._current_model.child_tags.concat(arrangement.accepted_child_tags),
