...
const MoltresApplication = new Knowledge.Class({
    ...
    vfunc_activate: function () {
        ...
        if (this._controller === null) {
            let args = ['autobahn', this.app_json_path];
            let subprocess = Gio.Subprocess.new(args, Gio.SubprocessFlags.STDOUT_PIPE);
            let [victory, app_json] = subprocess.communicate_utf8(null, null);
