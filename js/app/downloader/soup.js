...
const BaseDownloader = imports.app.downloader.base;
...
const SoupDownloader = new Lang.Class({
    Name: 'SoupDownloader',
    Extends: BaseDownloader.BaseDownloader,
    ...
    _download_new_shards: function (directory, old_manifest, new_manifest, cancellable, callback) {
        ...
        let to_download = Utils.subtract_set(new_shards, old_shards, (shard) => shard.path);
