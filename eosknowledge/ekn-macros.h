...
/**
 * EKN_STYLE_CLASS_READER_ARTICLE_PAGE_ORNAMENT:
 *
 * A CSS class to match the ornament on the reader's ArticlePage.
 *
 * > **NOTE**
 * > This is unstable API.
 */
#define EKN_STYLE_CLASS_READER_ARTICLE_PAGE_ORNAMENT "article-page-ornament"
