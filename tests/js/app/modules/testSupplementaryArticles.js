...
const SupplementaryArticles = imports.app.modules.supplementaryArticles;
...
describe('Supplementary articles module', function () {
    ...
    beforeEach(function () {
        ...
        factory.add_named_mock('supplementary-articles', SupplementaryArticles.SupplementaryArticles, {
