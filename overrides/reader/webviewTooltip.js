...
const WebviewTooltip = new Lang.Class({
    ...
    _ARCHIVE_ICON: 'resource:///com/endlessm/knowledge/reader/archive.svg',
    ...
    _pack_in_issue_link_tooltip: function () {
        ...
        page_number_label.get_style_context().add_class(EosKnowledge.STYLE_CLASS_READER_TOOLTIP_TYPE_LABEL);
    ...
    _pack_archive_link_tooltip : function () {
        ...
        archive_type_label.get_style_context().add_class(EosKnowledge.STYLE_CLASS_READER_TOOLTIP_TYPE_LABEL);
